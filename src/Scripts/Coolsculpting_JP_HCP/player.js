...
!function(e, t) {
  ...
  function i() {
      ...
      if (n(o))
          return "https://vimeo.com/" + o;
      if (r(o))
          return o.replace("http:", "https:");
      if (t)
          throw new TypeError("â€œ" + t + "â€ is not a valid video id.");
      throw new TypeError("â€œ" + o + "â€ is not a vimeo.com url.")
  }
  function o(e, t) {
      return t = {
          exports: {}
  ...
  function h(e) {
      ...
      return new Promise(function(n, i) {
          if (!r(e))
              throw new TypeError("â€œ" + e + "â€ is not a vimeo.com url.");
          ...
          u.onload = function() {
              if (404 === u.status)
                  return void i(new Error("â€œ" + e + "â€ was not found."));
              if (403 === u.status)
                  return void i(new Error("â€œ" + e + "â€ is not embeddable."));
              try {
  ...
  o(function(e) {
      ...
      !function(t, n, r) {
          ...
          var f, h, d, v = Object.prototype.toString, p = "undefined" != typeof setImmediate ? function(e) {
    ...
    , Player = function() {
      function Player(e) {
          ...
          var u = new E(function(t, a) {
              ...
              if (window.addEventListener ? window.addEventListener("message", u, !1) : window.attachEvent && window.attachEvent("onmessage", u),
              "IFRAME" !== n.element.nodeName) {
                  var s = f(e, o);
                  h(i(s), s).then(function(t) {
                      var r = d(t, e);
                      return n.element = r,
      ...
      return j(Player, [{
          ...
          value: function(e, t) {
              ...
              0 === u(this, "event:" + e).length && this.callMethod("addEventListener", e).catch(function() {}),
              a(this, "event:" + e, t)
          }
      }, {
          key: "off",
          ...
          key: "ready",
          value: function() {
              var e = x.get(this) || new E(function(e, t) {
          ...
          value: function() {
              ...
              return new E(function(t) {
                  x.delete(e),
                  M.delete(e.element),
                  e._originalElement && (M.delete(e._originalElement),
                  e._originalElement.removeAttribute("data-vimeo-initialized")),
                  e.element && "IFRAME" === e.element.nodeName && e.element.remove(),
                  t()
              }
              )
          }
          ...
          if (r(t.origin) && t.data && "spacechange" === t.data.event)
              for (var n = e.querySelectorAll("iframe"), i = 0; i < n.length; i++)
                  if (n[i].contentWindow === t.source) {
                      ...
                      o && -1 !== o.className.indexOf("vimeo-space") && (o.style.paddingBottom = t.data.data[0].bottom + "px");
                      break
                  }
      };
